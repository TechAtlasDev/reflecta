  ...
  return (
    <div className='w-full bg-slate-950 font-sans md:px-10' ref={containerRef}>
      <div className='max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10'>
        <h2 className='text-4xl md:text-5xl mb-4 text-white font-bold max-w-4xl'>
          {title}
        </h2>
          ...
          >
            <div className='sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full'>
              <div className='h-10 absolute left-3 md:left-3 w-10 rounded-full bg-slate-900  flex items-center justify-center'>
                <div className='h-2 w-2 rounded-full g-neutral-800 border border-white p-2 animate-ping' />
              </div>
